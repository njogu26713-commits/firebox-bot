...
const loadSettings = async () => {
    ...
    if (settingsCache) {
        ...
        if (settingsCache.author && (settingsCache.author.includes("Ibrahim") || settingsCache.author.includes("ibrahim") || settingsCache.author.includes("White Wizard"))) {
            settingsCache.author = "Firebox Studios";
            updates.author = "Firebox Studios";
            if (settingsCache.dataValues) {
                settingsCache.dataValues.author = "Firebox Studios";
            }
            needsUpdate = true;
        }
